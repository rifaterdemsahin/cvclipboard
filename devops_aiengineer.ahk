; devops_aiengineer.ahk
; AutoHotkey (v1) script to expand the trigger "/devopsengineer" into a greeting.
...
; - If you want case-insensitive matching, change the hotstring to: :i:/devopsengineer::
